  ...
  Drupal.behaviors.menuLinkDetailsSummaries = {
    attach: function (context) {
      $(context).find('.menu-link-form').drupalSetSummary(function (context) {
        var $context = $(context);
        if ($context.find('input.menu-link-enabled').is(':checked')) {
          return Drupal.checkPlain($context.find('input.menu-link-title').val());
        }
        else {
  ...
  Drupal.behaviors.menuLinkLinkAutomaticTitle = {
    attach: function (context) {
      ...
      $context.find('.menu-link-form').each(function () {
        ...
        // alterations.
        var $checkbox = $this.find('input.menu-link-enabled');
        var $link_title = $context.find('input.menu-link-title');
