 ...
 *     "allowed_html_automatic_tag" = FALSE,
...
class FilterHtml extends FilterBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    if ($this->settings['allowed_html_automatic_tag']) {
      $form['allowed_html']['#attached'] = [
        'library' => [
    ...
    $form['allowed_html_automatic_tag'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable automatic tags'),
      '#default_value' => $this->settings['allowed_html_automatic_tag'],
      '#description' => $this->t('By enabling this option, Drupal will automatically add items to the Allowed HTML tags configuration based on enabled filters.'),
    ];
